...
+ [Huggingface](https://huggingface.co/spaces) is an online platform where people can share, test, and publish AI models and web apps.  Students can use Hugging Face Spaces to upload and run Gradio apps on the web so that others can open and use them through a link. 🐥 [sample model: image-to-video](FrameAI4687/Omni-Video-Factory)
